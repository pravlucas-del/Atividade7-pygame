...
pygame.display.set_caption("Verificação de Usuário")
...
LISTA_PALAVRAS = ["DESTINY", "PLAYSTATION", "XBOX", "NINTENDO", "MARIOKART", "ELDENRING", "MINECRAFT"]
...
def desenhar_forca(erros):
    ...
    partes = [
        ...
        lambda: pygame.draw.line(TELA, PRETO, (350, 300), (300, 350), 5), # Braço Direito
        lambda: pygame.draw.line(TELA, PRETO, (350, 300), (400, 350), 5), # Braço Esquerdo
        lambda: pygame.draw.line(TELA, PRETO, (350, 400), (310, 480), 5), # Perna Direita
        lambda: pygame.draw.line(TELA, PRETO, (350, 400), (390, 480), 5), # Perna Esquerda
    ]
