...
boy_img = image.load("Atividade_11/pixelArt/fighter/Attack_01.png")
...
for i in range(3):
    boy_fight_list.append(image.load(f"Atividade_11/pixelArt/Fighter/Attack_0{i+1}.png"))
...
while True:
    ...
    if run_animation1:
        anim_time_n = anim_time_n + dt
        anim_time_n_sec = anim_time_n/1000

        if anim_time_n_sec > 0.1:
            curr_frame_n +=1
            if curr_frame_n > 11:
                curr_frame_n = 0
                run_animation1 = False
    ...
    screen.blit(samurai_walk, (0,100),(128*(curr_frame_s%8), 128*(curr_frame_s//8),128,128))

    screen.blit(boy_fight, (0,0),(128*(curr_frame%4),128*(curr_frame//4),128,128))

    screen.blit(shinobi_jump,(0,200), (128*(curr_frame_n%12),128*(curr_frame_n//12),128,128))
