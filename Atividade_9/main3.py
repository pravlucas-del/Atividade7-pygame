...
def randomColor():
    r = randint(100,200) # Gera um valor aleatório para a componente vermelha (R) da cor
    g = randint(60,150) # Gera um valor aleatório para a componente verde (G) da cor
    b = randint(0,100) # Gera um valor aleatório para a componente azul (B) da cor
...
def drawSquare(t,size):
    ...
    t.fillcolor('white') # Define a cor de preenchimento usando a função randomColor()
...
def estrela(t,size):
    ...
    t.color("purple") # Define a cor da caneta usando a função randomColor()
    t.fd(size) # Move para frente com o tamanho especificado
...
def arvore(t,size):
    if size == 0: # Condição de parada para a recursão, quando o tamanho do ramo for 0, a função retorna sem fazer nada
        return
    t.lt(90) # Gira 90 graus para a esquerda para orientar a tartaruga para cima, criando a base da árvore
    t.color("black") # Define a cor da caneta usando a função randomColor()
    t.fd(size) # Move para frente com o tamanho especificado
